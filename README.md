...
> Ricoh Supply CLI is a _"blazingly fast 🤣"_ Go CLI tool that allows checking Ricoh printers supply/toner status with SNMP protocol.
...
Below command will build the binaries in the `./__dist/` directory as `ricoh-supply-cli-go.exe`
